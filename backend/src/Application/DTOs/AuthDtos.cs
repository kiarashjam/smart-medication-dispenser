...
public record LinkedCaregiverSummaryDto(Guid UserId, string FullName, string Email);
...
public record MeProfileResponse(
    ...
    string FullName,
    string Role,
    IReadOnlyList<UserDeviceSummaryDto> Devices,
    LinkedCaregiverSummaryDto? LinkedCaregiver);
